...
export default function RepoSelector({ 
  ...
  return (
    <motion.div
      ...
      className="cosmic-card rounded-xl overflow-hidden max-w-2xl mx-auto"
    >
      ...
      <div className="p-4 border-b border-purple-500/10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 text-sm text-gray-400 hover:text-purple-300 hover:bg-purple-500/10 rounded-lg transition-colors"
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 text-sm rounded-lg transition-colors ${
              showPrivateOnly
                ...
                : 'text-gray-400 border border-purple-500/10 hover:border-purple-500/30'
            }`}
